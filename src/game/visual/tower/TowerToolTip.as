package game.visual.tower 
{
	...
	public class TowerToolTip extends Sprite 
	{
		...
		private function createBack():void 
		{
			...
			backQuadBatch.pivotX = backQuad.width >> 1;
			backQuadBatch.pivotY = backQuad.height >> 1;
		...
		private function createTextFields():void
		{
			...
			_textFieldsContainer.pivotX = _toolTipWidth >> 1;
			_textFieldsContainer.pivotY = _toolTipHeight >> 1;
